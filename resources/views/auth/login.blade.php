...
<div class="min-h-screen bg-[url('images/bg1.jpg')] bg-cover bg-center py-6 flex flex-col justify-center sm:py-12">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div class="relative">
                                <button class="bg-cyan-500 text-white rounded-md px-2 py-1 w-full">Login</button>
                            </div>
                        </div>
                    </div>
                </form>
